...
<script type="module">
  ...
  import * as x448 from "https://esm.sh/@hpke/dhkem-x448@0.22.2";
  // ...
</script>
...
<script type="module">
  ...
  import * as x448 from "https://unpkg.com/@hpke/dhkem-x448@0.22.2/esm/mod.js";
  // ...
</script>
```
...
import * as x448 from "https://deno.land/x/hpke@0.22.2/x/dhkem-x448/mod.ts";
...
curl -sS -o $YOUR_SRC_PATH/hpke-dhkem-x448.min.js https://esm.sh/v86/@hpke/dhkem-x448@0.22.2/es2022/hpke-dhkem-x448.min.js
```
...
<html>
  ...
  <body>
    <script type="module">
      ...
      import { DhkemX448HkdfSha512 } from "https://esm.sh/@hpke/dhkem-x448@0.22.2";
...
import { DhkemX448HkdfSha512 } from "https://deno.land/x/hpke@0.22.2/x/dhkem-x448/mod.ts";
