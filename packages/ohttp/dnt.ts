...
const outDir = "../../npm/packages/ohttp";

await beforeBuild("ohttp");
...
await build({
  ...
  postBuild() {
    ...
    copySync(
      ...
      "../../npm/test/ohttp/runtimes/browsers",
      { overwrite: true },
    );
    copySync(
      "test/runtimes/cloudflare",
      "../../npm/test/ohttp/runtimes/cloudflare",
      { overwrite: true },
    );
    copySync(
      "test/runtimes/fastly",
      "../../npm/test/ohttp/runtimes/fastly",
      { overwrite: true },
    );
  ...
  package: {
    ...
    description: "Oblivious HTTP (RFC 9458) client and server using HPKE",
    repository: {
      type: "git",
      url: "git+https://github.com/dajiaji/hpke-js.git",
    },
    homepage:
      "https://github.com/dajiaji/hpke-js/tree/main/packages/ohttp#readme",
    license: "MIT",
    main: "./esm/mod.js",
    types: "./esm/mod.d.ts",
    sideEffects: false,
