...
await emptyDir("../../npm/x/dhkem-secp256k1");

await build({
  entryPoints: ["./mod.ts"],
  outDir: "../../npm/x/dhkem-secp256k1",
  typeCheck: "both",
  test: true,
  declaration: true,
  scriptModule: "umd",
...
// post build steps
Deno.copyFileSync("LICENSE", "../../npm/x/dhkem-secp256k1/LICENSE");
Deno.copyFileSync("README.md", "../../npm/x/dhkem-secp256k1/README.md");
