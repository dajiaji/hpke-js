...
<script type="module">
  ...
  import * as chacha20 from "https://esm.sh/@hpke/chacha20poly1305@0.22.2";
  // ...
</script>
...
<script type="module">
  ...
  import * as chacha20 from "https://unpkg.com/@hpke/chacha20poly1305@0.22.2/esm/mod.js";
  // ...
</script>
```
...
import * as chacha20 from "https://deno.land/x/hpke@0.22.2/x/chacha20poly1305/mod.ts";
...
curl -sS -o $YOUR_SRC_PATH/hpke-chacha20poly1305.min.js https://esm.sh/v86/@hpke/chacha20poly1305@0.22.2/es2022/hpke-chacha20poly1305.min.js
```
...
<html>
  ...
  <body>
    <script type="module">
      // import * as hpke from "https://esm.sh/hpke-js@0.22.2";
      import { KemId, KdfId, CipherSuite } from "https://esm.sh/hpke-js@0.22.2";
      import { Chacha20Poly1305 } from "https://esm.sh/@hpke/chacha20poly1305@0.22.2";
...
```js
import { KemId, KdfId, CipherSuite } from "https://deno.land/x/hpke@0.22.2/mod.ts";
import { Chacha20Poly1305 } from "https://deno.land/x/hpke@0.22.2/x/chacha20poly1305/mod.ts";
